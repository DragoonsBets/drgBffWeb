package com.dragoons.core.repository;

import com.dragoons.core.DrgBffWebApp;
import com.dragoons.core.config.Constants;
import com.dragoons.core.config.audit.AuditEventConverter;
import com.dragoons.core.domain.PersistentAuditEvent;
...
import static com.dragoons.core.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
@SpringBootTest(classes = DrgBffWebApp.class)
@Transactional
